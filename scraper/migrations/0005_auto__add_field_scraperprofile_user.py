...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ScraperProfile.user'
        db.add_column('scraper_scraperprofile', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, on_delete=models.SET_NULL),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ScraperProfile.user'
        db.delete_column('scraper_scraperprofile', 'user_id')
