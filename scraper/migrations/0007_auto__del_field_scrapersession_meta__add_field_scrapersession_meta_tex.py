...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ScraperSession.meta'
        db.delete_column('scraper_scrapersession', 'meta')

        # Adding field 'ScraperSession.meta_text'
        db.add_column('scraper_scrapersession', 'meta_text',
                      self.gf('django.db.models.fields.TextField')(default='{}', null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'ScraperSession.meta'
        db.add_column('scraper_scrapersession', 'meta',
                      self.gf('django.db.models.fields.TextField')(default='{}', null=True, blank=True),
                      keep_default=False)

        # Deleting field 'ScraperSession.meta_text'
        db.delete_column('scraper_scrapersession', 'meta_text')
