...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ScraperProfile.url_pattern'
        db.add_column('scraper_scraperprofile', 'url_pattern',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


        # Changing field 'ScraperProfile.url'
        db.alter_column('scraper_scraperprofile', 'url', self.gf('django.db.models.fields.URLField')(max_length=255))

    def backwards(self, orm):
        # Deleting field 'ScraperProfile.url_pattern'
        db.delete_column('scraper_scraperprofile', 'url_pattern')


        # Changing field 'ScraperProfile.url'
        db.alter_column('scraper_scraperprofile', 'url', self.gf('django.db.models.fields.URLField')(max_length=200))
    ...
    models = {
        ...
        'scraper.scraperprofile': {
            ...
            'url_pattern': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
        ...
        'scraper.scrapersession': {
            ...
            'meta_text': ('django.db.models.fields.TextField', [], {'default': "'{}'", 'null': 'True', 'blank': 'True'}),
